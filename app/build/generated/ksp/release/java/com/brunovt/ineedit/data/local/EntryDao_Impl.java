  ...
  public EntryDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__upsertionAdapterOfEntryEntity = new EntityUpsertionAdapter<EntryEntity>(new EntityInsertionAdapter<EntryEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT INTO `entries` (`id`,`column`,`name`,`timeKey`,`specificDate`,`costAmountMinor`,`costCurrency`,`place`,`tags`,`completedAt`,`createdAt`,`updatedAt`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
      }
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE `entries` SET `id` = ?,`column` = ?,`name` = ?,`timeKey` = ?,`specificDate` = ?,`costAmountMinor` = ?,`costCurrency` = ?,`place` = ?,`tags` = ?,`completedAt` = ?,`createdAt` = ?,`updatedAt` = ? WHERE `id` = ?";
      }
      ...
      public List<EntryEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new EntryEntity(_tmpId,_tmpColumn,_tmpName,_tmpTimeKey,_tmpSpecificDate,_tmpCostAmountMinor,_tmpCostCurrency,_tmpPlace,_tmpTags,_tmpCompletedAt,_tmpCreatedAt,_tmpUpdatedAt);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public EntryEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final long _tmpUpdatedAt;
            _tmpUpdatedAt = _cursor.getLong(_cursorIndexOfUpdatedAt);
            _result = new EntryEntity(_tmpId,_tmpColumn,_tmpName,_tmpTimeKey,_tmpSpecificDate,_tmpCostAmountMinor,_tmpCostCurrency,_tmpPlace,_tmpTags,_tmpCompletedAt,_tmpCreatedAt,_tmpUpdatedAt);
          } else {
            _result = null;
          }
          return _result;
