  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `entries` (`id` TEXT NOT NULL, `column` TEXT NOT NULL, `name` TEXT NOT NULL, `timeKey` TEXT, `specificDate` TEXT, `costAmountMinor` INTEGER, `costCurrency` TEXT, `place` TEXT, `tags` TEXT NOT NULL, `completedAt` INTEGER, `createdAt` INTEGER NOT NULL, `updatedAt` INTEGER NOT NULL, PRIMARY KEY(`id`))");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'eb774fa9d610007675c9f10a43bf1429')");
      }
    ...
    }, "eb774fa9d610007675c9f10a43bf1429", "5b2f3f7a7507b02774e18127836e2340");
